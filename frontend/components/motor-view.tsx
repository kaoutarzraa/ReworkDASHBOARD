        ...
        <div className="lg:col-span-2">
          <Card className={`${cardBg} ${cardBorder} hover:shadow-xl transition-shadow duration-300 backdrop-blur-sm`}>
            <CardHeader>
              ...
              <p className="text-xs text-slate-400">Showing latest motor cables • Live data updates every 5 seconds</p>
            </CardHeader>
            <CardContent>
              ...
              <div className="mt-2 text-xs text-slate-500 flex justify-between items-center">
                <span>Total motor cables: {chartData.recentMotorCables.length}</span>
